...
@Component({
  selector: 'app-homepage-mediator',
  templateUrl: './homepage-mediator.component.html',
  styleUrls: ['./homepage-mediator.component.css']
})
export class HomepageMediatorComponent implements OnInit {
  [x: string]: any;
  ...
  cards3 = [
    {
      ...
      description: 'Some quick example text to build on the card title and make up the bulk of the card content',
      buttonText: 'Button',
      img: 'assets/img/news-events.jpg',
      auther:'anubhandh',
      date:'25th October 2022'
    },
    {
      ...
      description: 'Some quick example text to build on the card title and make up the bulk of the card content',
      buttonText: 'Button',
      img: 'assets/img/news-event1.jpg',
      auther:'anubhandh',
      date:'25th October 2022'
    },
    {
