...
@Component({
  selector: 'app-registration-add-education',
  templateUrl: './registration-add-education.component.html',
  styleUrls: ['./registration-add-education.component.css']
})
export class RegistrationAddEducationComponent implements OnInit {
