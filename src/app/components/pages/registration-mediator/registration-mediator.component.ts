...
@Component({
  selector: 'app-registration-mediator',
  templateUrl: './registration-mediator.component.html',
  styleUrls: ['./registration-mediator.component.css']
})
export class RegistrationMediatorComponent implements OnInit {
