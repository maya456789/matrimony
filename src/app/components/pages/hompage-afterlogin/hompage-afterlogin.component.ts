...
@Component({
  selector: 'app-hompage-afterlogin',
  templateUrl: './hompage-afterlogin.component.html',
  styleUrls: ['./hompage-afterlogin.component.css']
})
export class HompageAfterloginComponent implements OnInit {
